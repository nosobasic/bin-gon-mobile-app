...
const AdminBottomSheet: React.FC<AdminBottomSheetProps> = ({ activeTab, onTabPress }) => {
  ...
  const tabs = [
    { 
      ...
      activeIcon: require('../assets/images/Dasboard_active.png')
    },
    { 
      name: 'Categories', 
    ...
    { 
      ...
      activeIcon: require('../assets/images/donations_active.png')
    },
    { 
      name: 'Users', 
      icon: require('../assets/images/user_management.png'),
      activeIcon: require('../assets/images/user_management_active.png')
    },
